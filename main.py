...
def main():
    # Convert multiple NIfTI files to DICOM series
    input_nifti_directory = 'path/to/nifti_files_directory'
    output_directory = 'path/to/output_directory'

    nifti2dicom_mfiles(input_nifti_directory, output_directory)
